...
@Composable
fun SemesterScreen(modifier: Modifier = Modifier) {
        ...
        topBar = {
            Column {
                ...
                TabRow(
                    ...
                    // HILANGKAN GARIS HITAM DI BAWAH TAB
                    divider = {},
                    // KUSTOM INDIKATOR 42.dp BERWARNA #3D5CFF
                    ...
                    tabTitles.forEachIndexed { index, title ->
                        Tab(
                            ...
                            Text(
                                text = title,
                                fontSize = 16.sp,
                                fontWeight = FontWeight.Medium, fontFamily = poppinsfamily,
